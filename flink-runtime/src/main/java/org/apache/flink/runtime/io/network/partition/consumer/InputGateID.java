 ...
 *
 * <p>At runtime the {@link org.apache.flink.runtime.jobgraph.IntermediateDataSetID} is not enough to uniquely
 * identify an input gate. It needs to be associated with the consuming task as well to ensure
 * correct tracking of gates in shuffle implementation.
 */
public class InputGateID implements Serializable {
	 ...
	 *
	 * <p>The ID of {@link org.apache.flink.runtime.executiongraph.Execution} and
	 * its local {@link org.apache.flink.runtime.taskmanager.Task}.
	 */
