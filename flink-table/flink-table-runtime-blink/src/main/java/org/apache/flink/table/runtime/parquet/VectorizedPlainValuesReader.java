...
public class VectorizedPlainValuesReader extends ValuesReader implements VectorizedValuesReader {
	...
	@Override
	public final void readIntegers(int total, HeapIntVector c, int rowId) {
	...
	@Override
	public final void readBinaries(int total, HeapBytesVector v, int rowId) {
		for (int i = 0; i < total; i++) {
			int len = readInteger();
	...
	public final void readBytes(int total, HeapByteVector c, int rowId) {
		for (int i = 0; i < total; i++) {
