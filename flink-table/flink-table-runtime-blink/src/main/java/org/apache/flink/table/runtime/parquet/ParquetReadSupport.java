...
public class ParquetReadSupport extends ReadSupport<Row> {
	...
	ParquetReadSupport(LogicalType[] fieldTypes, String[] fieldNames) {
	...
	public ReadContext init(InitContext context) {
		...
		return new ReadContext(requestedSchema, new HashMap<>());
	}
	 ...
	 */
	static MessageType clipParquetSchema(GroupType parquetSchema, String[] fieldNames) {
